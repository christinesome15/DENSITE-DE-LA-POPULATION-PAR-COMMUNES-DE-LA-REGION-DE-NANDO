...
var style_COMMUNE_REGION_NANDO1_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Dens") !== null) {
        labelText = String(feature.get("Dens"));
    }
    if (value >= 32.084000 && value <= 116.815600) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 116.815600 && value <= 201.547200) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 201.547200 && value <= 286.278800) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 286.278800 && value <= 371.010400) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 371.010400 && value <= 455.742000) {
            style = [ new ol.style.Style({
